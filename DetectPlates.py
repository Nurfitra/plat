...
def detectPlatesInScene(imgOriginalScene):
    ...
    print "\n" + str(len(listOfPossiblePlates)) + " Plat ditemukan"          # 13 with MCLRNF1 image
    ...
    if Main.showSteps == True: # show steps #######################################################
        ...
        cv2.waitKey(0)
    # end if # show steps #########################################################################
    #listOfPossiblePlates = cv2.bitwise_not(listOfPossiblePlates)
...
def findPossibleCharsInScene(imgThresh):
    ...
    imgContours = np.zeros((height, width, 3), np.uint8)
    imgContours = cv2.bitwise_not(imgContours)
